...
describe Ponominalu::Middleware do
  ...
  let(:response_env_api_error) { double('Env object', body: double('Body', code: -200, message: 'API error', method_name: 'test_method', session: Ponominalu.session, params: {}), status: 200) }
